  ...
  <div id="sider_scrollbox">
    ...
    <div class="sider_group on">
      ...
      <div class="sider_group_list list-group">
        ...
        <a href="{{site_url url='project/demand'}}" class="list-group-item {{if $type==3}}active{{/if}}" data-toggle="tooltip" data-placement="right" title="需求信管理"><i class="material-icons">&#xe0c6;</i><span>需求信息管理</span></a>
